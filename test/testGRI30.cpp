...
void testProductionRates(Cantera::IdealGasMix& gas) {
  ...
  out.open("outputData/gri30/speciesSourceTerm.ct.dat");
  ...
  out.open("outputData/gri30/speciesSourceTerm.mech.dat");
...
void testNetRatesOfProgress(Cantera::IdealGasMix& gas) {
  ...
  /* get properties from cantera */
  out.open("outputData/gri30/netRates.ct.dat");
  ...
  /* now get properties from source.cpp */
  out.open("outputData/gri30/netRates.mech.dat");
...
void testRateCoefficients(Cantera::IdealGasMix& gas) {
  ...
  outFwd.open("outputData/gri30/fwdRateCoeffs.ct.dat");
  outRev.open("outputData/gri30/revRateCoeffs.ct.dat");
  ...
  outFwd.open("outputData/gri30/fwdRateCoeffs.mech.dat");
  outRev.open("outputData/gri30/revRateCoeffs.mech.dat");
...
void testEquilibriumConstants(Cantera::IdealGasMix& gas) {
  ...
  /* get properties from cantera */
  out.open("outputData/gri30/equilConstants.ct.dat");
  ...
  /* now get properties from source.cpp */
  out.open("outputData/gri30/equilConstants.mech.dat");
...
void testThermo(Cantera::IdealGasMix& gas) {
  ...
  /* get properties from cantera */
  outc.open("outputData/gri30/thermo.specificHeat.ct.dat");
  outh.open("outputData/gri30/thermo.enthalpy.ct.dat");
  outs.open("outputData/gri30/thermo.entropy.ct.dat");
  ...
  /* now get properties from source.cpp */
  outc.open("outputData/gri30/thermo.specificHeat.mech.dat");
  outh.open("outputData/gri30/thermo.enthalpy.mech.dat");
  outs.open("outputData/gri30/thermo.entropy.mech.dat");
...
int main() {
  ...
  Cantera::IdealGasMix gas("ctis/gri30.cti","gas");
